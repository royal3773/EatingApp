...
<div><a href="register/admin" class="btn btn-primary btn-lg btn-block">お店側の新規登録はこちらから</a></div>
<div><a href="login/admin" class="btn btn-outline-primary btn-lg btn-block">お店側のログインはこちらから</a></div>
</body>
</html>